...
class TestSmokeTest():
  ...
  def test_homePage2(self):
    ...
    WebDriverWait(self.driver, 30000).until(expected_conditions.text_to_be_present_in_element((By.CSS_SELECTOR, "section > h3"), "Welcome to the Teton Chamber of Commerce Signup Wizard!"))
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Loris")
    self.driver.find_element(By.NAME, "lname").send_keys("Ndonga")
    self.driver.find_element(By.NAME, "bizname").send_keys("BRIGHAM YOUNG UNIVERSITY - IDAHO")
